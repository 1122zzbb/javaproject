...
public class sp2 extends JFrame {
    public sp2(int finalI) throws HeadlessException {
        ...
        //*************创建数组************************
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹 - 副本/(4).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本/(2).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本/(3).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹 - 副本/(4).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">农夫山泉长白雪天然雪山矿泉水535ml*24瓶</p>\n" +
                "\t\t<p style=\"color: gray;font-size: 10px;\">月销 10万+</p>\n" +
                "\t\t<p>品牌秒杀<span style=\"color: red;font-size: 30px;\">￥49.9</span></p>\n" +
                "\t\t<p style=\"color: black;font-size: 15px;\"><span style=\"color: gray;font-size: 12px;\">" +
                "配送：</span>&ensp;浙江温州——南平市延平区<br>&emsp;&emsp;&ensp;&ensp;" +
                "<span style=\"color: red;font-size: 11px;\">快递: 免运费</span></p>\n" +
                "\t</html>");
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"长白雪雪山535ml*24","长白雪雪山535ml*12","长白雪雪山330ml*24"};
        String[] btnbannearr1={"长白雪雪山535ml*10","长白运动盖535ml*24","长白运动盖250ml*24"};
        //*************按钮数组*******************************
        ...
        String[] imgArra={"src/javas/src/javas/pn/新建文件夹 - 副本/(6).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本/(1).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本/(5).jpg"};
        for (int i=0;i<3;i++) {
