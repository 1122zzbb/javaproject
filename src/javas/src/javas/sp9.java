...
public class sp9 extends JFrame {
    public sp9(int finalI) throws HeadlessException {
        ...
        //*************创建数组************************
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹 - 副本 (8)/(1).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (8)/(6).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (8)/(2).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹 - 副本 (8)/(1).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">【新品】农夫山泉大柠檬鲜榨柠檬汁汽水380ml</p>\n" +
                "\t\t<p style=\"color: gray;font-size: 10px;\">月销 20万+</p>\n" +
                "\t\t<p>品牌力荐<span style=\"color: red;font-size: 30px;\">￥29.9</span></p>\n" +
        ...
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"大柠檬500ml*6","大柠檬500ml*12","大柠檬500ml*1"};
        String[] btnbannearr1={"大柠檬500ml*24","大柠檬500ml*36","大柠檬500ml*2"};
        //*************按钮数组*******************************
        ...
        String[] imgArra={"src/javas/src/javas/pn/新建文件夹 - 副本 (8)/(3).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (8)/(4).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (8)/(5).jpg"};
        for (int i=0;i<3;i++) {
