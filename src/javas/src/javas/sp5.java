...
public class sp5 extends JFrame {
    public sp5(int finalI) throws HeadlessException {
        ...
        //*************创建数组************************
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹 - 副本 (4)/(2).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (4)/(3).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (4)/(1).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹 - 副本 (4)/(2).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">农夫山泉苏打天然水饮品苏打水410ml*15</p>\n" +
        ...
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"白桃风味410ml*15","日向夏橘410ml*15","柠檬风味410ml*15"};
        String[] btnbannearr1={"柠檬风味410ml*6","白桃风味410ml*6","日向夏橘410ml*12"};
        //*************按钮数组*******************************
        ...
        String[] imgArra={"src/javas/src/javas/pn/新建文件夹 - 副本 (4)/(4).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (4)/(5).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (4)/(6).jpg"};
        for (int i=0;i<3;i++) {
