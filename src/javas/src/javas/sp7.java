...
public class sp7 extends JFrame {
    public sp7(int finalI) throws HeadlessException {
        ...
        //*************创建数组************************
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹 - 副本 (6)/(6).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (6)/(4).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (6)/(1).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹 - 副本 (6)/(6).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">农夫山泉水溶C100饮料445ml*15瓶</p>\n" +
                "\t\t<p style=\"color: gray;font-size: 10px;\">月销 50万+</p>\n" +
                "\t\t<p>品牌力荐<span style=\"color: red;font-size: 30px;\">￥72.5</span></p>\n" +
        ...
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"水溶C柠檬味445ml*15","水溶C西柚味445ml*15","水溶C青桔味445ml*15"};
        String[] btnbannearr1={"水溶C西柚味445ml*6","水溶C柠檬味445ml*6","水溶C青桔味445ml*6"};
        //*************按钮数组*******************************
        ...
        String[] imgArra={"src/javas/src/javas/pn/新建文件夹 - 副本 (6)/(2).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (6)/(3).jpg",
