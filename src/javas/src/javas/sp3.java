...
public class sp3 extends JFrame {
    public sp3(int finalI) throws HeadlessException {
        ...
        //*************创建数组************************
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹 - 副本 (2)/(5).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (2)/(6).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (2)/(4).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹 - 副本 (2)/(5).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">农夫山泉饮用天然水（适合婴幼儿）</p>\n" +
        ...
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"天然饮用水1L*5","天然饮用水1L*1","天然饮用水2L*5"};
        String[] btnbannearr1={"天然饮用水535ml*5","天然饮用水535L*24","天然饮用水2L*5"};
        //*************按钮数组*******************************
        ...
        String[] imgArra={"src/javas/src/javas/pn/新建文件夹 - 副本 (2)/(3).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (2)/(1).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (2)/(2).jpg"};
        for (int i=0;i<3;i++) {
