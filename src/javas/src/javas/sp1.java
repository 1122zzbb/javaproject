...
public class sp1 extends JFrame {
    public sp1(int finalI) throws HeadlessException {
        ...
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹/(1).jpg",
                "src/javas/src/javas/pn/新建文件夹/(2).jpg",
                "src/javas/src/javas/pn/新建文件夹/(3).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹/(1).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">农夫山泉饮用水天然水红盖水桶装水5L*4桶整箱</p>\n" +
                "\t\t<p style=\"color: gray;font-size: 10px;\">月销 6万+</p>\n" +
                "\t\t<p>品牌钜惠<span style=\"color: red;font-size: 30px;\">￥39.9</span></p>\n" +
                "\t\t<p style=\"color: black;font-size: 15px;\"><span style=\"color: gray;font-size: 12px;\">" +
                "配送：</span>&ensp;浙江杭州——南平市延平区<br>&emsp;&emsp;&ensp;&ensp;" +
                "<span style=\"color: red;font-size: 11px;\">快递: 免运费</span></p>\n" +
                "\t</html>");
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"饮用天然水5L*4","饮用天然水12L*4","饮用天然水5L*6"};
        String[] btnbannearr1={"饮用天然水8L*5","饮用天然水10L*4","饮用天然水6L*6"};
        //*************按钮数组*******************************
...
//        JButton tiao=new JButton("回到首页");
//        tiao.addActionListener(new AbstractAction() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                top jf=new top();
//
...
//        });
        ...
        String[] imgArra={"src\\javas\\src\\javas\\pn\\新建文件夹\\(4).jpg",
                "src\\javas\\src\\javas\\pn\\新建文件夹\\(5).jpg",
                "src\\javas\\src\\javas\\pn\\新建文件夹\\(6).jpg"};
        for (int i=0;i<3;i++) {
