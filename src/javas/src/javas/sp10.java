...
public class sp10 extends JFrame {
    public sp10(int finalI) throws HeadlessException {
        ...
        //*************创建数组************************
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹 - 副本 (9)/(6).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (9)/(5).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (9)/(4).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹 - 副本 (9)/(6).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">农夫山泉官方旗舰店维他命水功能饮料</p>\n" +
                "\t\t<p style=\"color: gray;font-size: 10px;\">月销 20万+</p>\n" +
                "\t\t<p>品牌力荐<span style=\"color: red;font-size: 30px;\">￥49.9</span></p>\n" +
        ...
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"维他命水500ml*15","维他命水250ml*12","柠檬味500ml*15"};
        String[] btnbannearr1={"石榴蓝莓味500ml*15","蓝莓树莓味500ml*15","热带水果味500ml*15"};
        //*************按钮数组*******************************
        ...
        String[] imgArra={"src/javas/src/javas/pn/新建文件夹 - 副本 (9)/(2).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (9)/(3).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (9)/(1).jpg"};
        for (int i=0;i<3;i++) {
