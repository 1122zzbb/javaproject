...
public class sp8 extends JFrame {
    public sp8(int finalI) throws HeadlessException {
        ...
        //*************创建数组************************
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹 - 副本 (7)/(2).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (7)/(6).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (7)/(1).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹 - 副本 (7)/(2).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">农夫果园30%混合口味450ml*15（新口味）</p>\n" +
        ...
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"苹果芭乐450ml*15","桃苹果芭450ml*15","桃果芭乐450ml*15"};
        String[] btnbannearr1={"桃苹果芭450ml*12","苹果芭乐450ml*12","桃果芭乐450ml*12"};
        //*************按钮数组*******************************
        ...
        String[] imgArra={"src/javas/src/javas/pn/新建文件夹 - 副本 (7)/(5).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (7)/(3).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (7)/(4).jpg"};
        for (int i=0;i<3;i++) {
