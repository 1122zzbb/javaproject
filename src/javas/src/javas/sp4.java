...
public class sp4 extends JFrame {
    public sp4(int finalI) throws HeadlessException {
        ...
        //*************创建数组************************
        String[] imgArray={"src/javas/src/javas/pn/新建文件夹 - 副本 (3)/(5).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (3)/(6).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (3)/(4).jpg"};
//**********************头部左边*********************************
        JPanel img=new JPanel();
        img.setLayout(new BoxLayout(img,BoxLayout.X_AXIS));
        ImageIcon img1= new ImageIcon("src/javas/src/javas/pn/新建文件夹 - 副本 (3)/(5).jpg");
...
//**********************头部左边*********************************
        ...
        JLabel tex=new JLabel("<html>\n" +
                "\t\t<p style=\"font-size: 20px;\">农夫山泉泡茶水山泉水饮用水桶装水4L*4瓶</p>\n" +
                "\t\t<p style=\"color: gray;font-size: 10px;\">月销 20万+</p>\n" +
                "\t\t<p>品牌力荐<span style=\"color: red;font-size: 30px;\">￥57.5</span></p>\n" +
                "\t\t<p style=\"color: black;font-size: 15px;\"><span style=\"color: gray;font-size: 12px;\">" +
                "配送：</span>&ensp;福建武夷山——南平市延平区<br>&emsp;&emsp;&ensp;&ensp;" +
                "<span style=\"color: red;font-size: 11px;\">快递: 免运费</span></p>\n" +
                "\t</html>");
        righttop.add(tex);
        //*************按钮数组*******************************
        String[] btnbannearr={"饮用山泉水1L*5","天然泡茶水1L*1","饮用山泉水2L（兑换卡）"};
        String[] btnbannearr1={"天然泡茶水1L*5","饮用山泉水2L*5","天然饮用水2L*5"};
        //*************按钮数组*******************************
        ...
        String[] imgArra={"src/javas/src/javas/pn/新建文件夹 - 副本 (3)/(3).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (3)/(2).jpg",
                "src/javas/src/javas/pn/新建文件夹 - 副本 (3)/(1).jpg"};
        for (int i=0;i<3;i++) {
